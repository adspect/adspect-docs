...
:::{note}
Adspect integration files do not contain stream settings.  You can change any stream settings at any time, and these changes
...
When transferring control to other PHP files or doing reverse PHP integration into them, you can obtain
...
:::{note}
Safe page settings are ignored with JavaScript integration because visitors initially land on the safe page, i.e. the safe page
is always the page that contains the JavaScript integration code.
:::
