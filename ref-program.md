...
**The referral fee is 5%.** However, it may be increased individually if you manage to bring new clients
...
On the technical side, we use both a cookie with one month expiration time and a parameter in the link
that we e-mail to new customers in order to complete registration, which means that even if they do so
on a different device, they will still be accounted to you.
