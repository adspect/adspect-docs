...
## Countries, Operating Systems, Browsers, and Languages

These manual targeting options allow you to further restrict your stream to only allow visitors from specified
countries and/or using specified operating systems, browsers, and browser language preferences. You would normally
